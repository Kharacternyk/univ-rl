...
def do_value_iteration(
    ...
    value_table = torch.zeros(position_discrete_count, velocity_discrete_count)

    for _ in range(max_iteration_count):
        value_table = get_improved_value_table(
            value_table, policy_table, discount_factor
        )
...
if __name__ == "__main__":
    ...
    start = time()
    optimal_policy_table = do_value_iteration(
        100,
        0.72,
        position_discrete_count,
        velocity_discrete_count,
